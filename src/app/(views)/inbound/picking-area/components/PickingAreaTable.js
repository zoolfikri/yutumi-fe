...
import PickingAreaStatus from "./PickingAreaStatus";
import CIcon from "@coreui/icons-react";
import { cilFindInPage } from "@coreui/icons";

const PickingAreaTable = () => {
  ...
  const getPickingAreas = useCallback(() => {
    if (fetchId) {
      ...
      scopedColumns={{
        status: (item) => (
          <td className="text-center">
            <PickingAreaStatus status={item.status} />
          </td>
        ),
        action: (item) => (
          <td className="text-center">
...
export default PickingAreaTable;
