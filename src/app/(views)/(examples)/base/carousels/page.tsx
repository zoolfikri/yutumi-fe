...
import { DocsExample } from '@/components/layout'
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/carousel">
              <CCarousel>
                <CCarouselItem>
                  <Image width={100} height={100} className="d-block w-100 h-100" src={ReactImg.src} alt="slide 1" />
                </CCarouselItem>
                <CCarouselItem>
                  <Image width={100} height={100} className="d-block w-100 h-100" src={AngularImg.src} alt="slide 2" />
                </CCarouselItem>
                <CCarouselItem>
                  <Image width={100} height={100} className="d-block w-100 h-100" src={VueImg.src} alt="slide 3" />
                </CCarouselItem>
              </CCarousel>
            </DocsExample>
          </CCardBody>
          ...
          <CCardBody>
            ...
            <DocsExample href="components/carousel/#dark-variant">
              <CCarousel controls indicators dark>
                <CCarouselItem>
                  <Image width={100} height={100} className="d-block w-100 h-100" src={slidesLight[0]} alt="slide 1" />
                  <CCarouselCaption className="d-none d-md-block">
                    <h5>First slide label</h5>
                    <p>Some representative placeholder content for the first slide.</p>
                  </CCarouselCaption>
                ...
                <CCarouselItem>
                  <Image width={100} height={100} className="d-block w-100 h-100" src={slidesLight[1]} alt="slide 2" />
                  <CCarouselCaption className="d-none d-md-block">
                    <h5>Second slide label</h5>
                    <p>Some representative placeholder content for the first slide.</p>
                  </CCarouselCaption>
                ...
                <CCarouselItem>
                  <Image width={100} height={100} className="d-block w-100 h-100" src={slidesLight[2]} alt="slide 3" />
                  <CCarouselCaption className="d-none d-md-block">
                    <h5>Third slide label</h5>
                    <p>Some representative placeholder content for the first slide.</p>
                  </CCarouselCaption>
